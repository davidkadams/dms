    ...
    <NavShell active="Template Studio">
      <div style={{ padding: "24px" }}>
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 22, fontWeight: 500, color: "#1a1020", letterSpacing: -0.3 }}>Template Studio</div>
          <div style={{ fontSize: 12, color: "#888", marginTop: 3 }}>Upload and manage your document templates</div>
        </div>
